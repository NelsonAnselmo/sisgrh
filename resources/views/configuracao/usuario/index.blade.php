    ...
    <div class="card card-primary card-outline">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    @include('configuracao.usuario.search')
                </div>
            </div>
                            ...
                            @forelse($usuarios  as $key=> $usu)
                                <tr>
                                    ...
                                    <td style="text-align-last: center;">
                                        <a href="{{ URL::action('UserController@show', $usu->id) }}"
                                            class="btn btn-primary btn-sm" title="Detalhes">
                                            <i class="right fa fa-eye"></i>
                                        </a>
                                        <a href="{{ URL::action('UserController@edit', $usu->id) }}"
                                            class="btn btn-primary btn-sm" title="Editar">
                                            <i class="right fa fa-edit"></i>
                                        </a>
                                        @if (Auth::user()->tipo == 'Administrador')
                                        <a href="{{ 'UserController@destroy', $usu->id }}"
                                            class="btn btn-danger btn-sm"
                                            data-target="#modal-delete-{{ $usu->id }}" data-toggle="modal"
                                            title="Elimiar">
                                ...
                                @include('configuracao.usuario.modal')
                            @empty
                                <tr>
