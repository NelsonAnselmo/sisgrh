            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-condensed table-hover">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="assi_a" class="custom-control-label">Cumpre o horário e está
                                                sempre presente, mostrando-se disposto a atender às
                                                necessidades de trabalho.</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="assi_b" class="custom-control-label"> Cumpre o horário
                                                estabelecido e é pontual nos seus compromissos de trabalho.</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="assi_c" class="custom-control-label"> Normalmente não cumpre o
                                                horário estabelecido, mas, quando presente, atende às
                                                necessidades de trabalho.</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="assi_d" class="custom-control-label"> Nunca cumpre horário e está
                                                sempre ausente.</label>
                                        </div>
                                    </div>
                                </div>
                            </td>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="res_a" class="custom-control-label">Conhece suas atribuições
                                                executando suas atividades acima das expectativas, antecipando-se às
                                                solicitações.</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="res_b" class="custom-control-label">Executa adequadamente as
                                                suas
                                                atividades de acordo com a responsabilidade estabelecidas para o seu
                                                departamento.</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="res_c" class="custom-control-label">Em algumas situações
                                                demonstra pouca atenção em relação a execução das atribuições do seu
                                                cargo.</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="res_d" class="custom-control-label">Não cumpre adequadamente
                                                suas atribuições.</label>
                                        </div>
                                    </div>
                                </div>
                            </td>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="meta_a" class="custom-control-label">Conhece a descrição fluxo,
                                                implementação e as suas metas e cumpriu com todas as expectativas ao alcance
                                                do pacote primário.</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="meta_b" class="custom-control-label">Executa adequadamente e
                                                tende a alcançar as metas que foram estabelecidas.</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="meta_c" class="custom-control-label">Em processo de alcance das
                                                metas e esta a trabalhar em meio dos desafios.</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="meta_d" class="custom-control-label">Não tem sessões regulares,
                                                tem tendências de não cumprimento do esperado.</label>
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="registo_a" class="custom-control-label">Promove e executa as
                                                actividades e na mesma semana, regista as actividades nos ficheiros físicos
                                                e eletrónicos semanalmente.</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="registo_b" class="custom-control-label">Cumpre com os reportes
                                                mensais e faz pelo menos duas visitas por mês para a actualização dos
                                                dados.</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="registo_c" class="custom-control-label">Conhece as
                                                responsabilidades de actualização de dados semanais e o bi-semanais mais
                                                actualiza dados só no final do mês para o reporte.</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label for="registo_d" class="custom-control-label">Não actualiza dados a
                                                tempo e tem pelo menos três atrasos no reporte de dados e na
                                                plataforma.</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="form-group">
                                    <select class="custom-select form-control-border border-width-2" name="registo_nota"
                                        required>
                                        <option value="">------------------</option>
                                        <option value="5 EXCELENTE">5</option>
                                        <option value="4 EXCELENTE">4</option>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="comentario" class="form-control" required placeholder="Enter ...">
                    </div>
                </div>
